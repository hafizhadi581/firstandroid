...
public class EighthQuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private CheckBox cbInterestedInOtherChildren;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cbInterestedInOtherChildren = findViewById(R.id.cb_interest_child);
    ...
    private void showCbInterestChild(){
        View cbInterestShow = findViewById(R.id.cb_interest);
        cbInterestShow.setVisibility(View.VISIBLE);
        View tvYq81Show = findViewById(R.id.tv_yq81);
        tvYq81Show.setVisibility(View.VISIBLE);
    }
    private void hideCbInterestChild(){
        View cbInterestHide= findViewById(R.id.cb_interest);
        cbInterestHide.setVisibility(View.GONE);
        View tvYq81Hide = findViewById(R.id.tv_yq81);
        tvYq81Hide.setVisibility(View.GONE);
    }
...
//        tvYq811Show.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        if(v == ivQ81){
            ...
            rules.setRule8(new Rule8(cbInterestedInOtherChildren.isChecked(),cbInterestedNotBrotherSister.isChecked(), cbRespondToOtherChildren.isChecked(), cbPlayingWithOtherChildren.isChecked(), cbTalkingToOtherChildren.isChecked(),
